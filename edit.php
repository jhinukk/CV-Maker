...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>jhinuk@mail.com</p>
  ...
  <?php
        ...
        while( $row = mysqli_fetch_assoc($result)) 
        {
          ...
          //echo "id:". $row["id"]."name ".$row["skill_name"]."skill ".$row["Skill_level"];
    ...
    <div class="w3-twothird">
      ...
      <?php
         if(isset($_POST["edit"]))
         {
          $name=$_POST["sname"];
          $level=$_POST["slevel"];
          $sql="UPDATE `skill` SET `skill_name` = '$name',`skill_level` = '$level' WHERE `id` = '$edit_id'";
          echo ($sql);
          if(mysqli_query($conn,$sql))
          {
            echo "<script>window.location='index.php'</script>";
             ...
             $sql="SELECT * FROM `skill` WHERE id='$edit_id'";
        $result=mysqli_query($conn,$sql);
...
<?php
        ...
        ?>
           ...
           <label class="w3-text-blue"><b>Skill Name</b></label>
            <input class="w3-input w3-border" name="sname" type="text" value="<?php echo $row['skill_name'];?>"></p>
            <p>      
            <label class="w3-text-blue"><b>Skill Level</b></label>
            <input class="w3-input w3-border" name="slevel" type="text" value="<?php echo $row['skill_level'];?>"></p>
           <p>      
           <button class="w3-btn w3-blue" name="edit">Edit</button></p>
</form>
      </div>
