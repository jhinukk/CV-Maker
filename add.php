    ...
    <div class="w3-twothird">
      ...
      <?php
         if(isset($_POST["add"]))
         {
          $name=$_POST["sname"];
          $level=$_POST["slevel"];
          $sql="INSERT INTO `skill` (`id`, `skill_name`, `skill_level`) VALUES (NULL, '$name', '$level')";
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Add Skills</h2>
           ...
           <label class="w3-text-blue"><b>Skill Name</b></label>
            ...
            <input class="w3-input w3-border" name="slevel" type="text"></p>
           <p>      
           <button class="w3-btn w3-blue" name="add">Register</button></p>
</form>
      </div>
